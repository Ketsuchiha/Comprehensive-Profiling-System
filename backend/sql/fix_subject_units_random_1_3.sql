-- Ensures subjects.units exists, fills units with random values from 1 to 3,
-- adds more rooms, and assigns rooms to schedules with NULL room_id.
-- Safe to run multiple times.

-- =====================================================
-- A) Ensure subjects.units exists
-- =====================================================
...
-- Fill invalid/missing units with random values from 1..3
UPDATE subjects
...
-- =====================================================
-- C) Assign room_id for schedules with NULL room_id
-- =====================================================
